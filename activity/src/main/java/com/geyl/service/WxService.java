...
public class WxService {
    ...
    public TransPayWalletResult transPayWallet(TransPayWallet transPayWallet) throws MyException {
        ...
        //发起请求，企业付款到零钱API
        Response response = httpsClient.postXmlWithCert("https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers", xml, wx_mchId, wx_keyPath, wx_mchId);
        //获取返回内容
    ...
    public TransPayWalletInfo getTransferInfo(String partnerTradeNo, String appid) throws MyException {
        ...
        //发起请求，查询企业付款到零钱API
        Response response = httpsClient.postXmlWithCert("https://api.mch.weixin.qq.com/mmpaymkttransfers/gettransferinfo", xml, wx_mchId, wx_keyPath, wx_mchId);
        //获取返回内容
        String xmlResult = response.asString();
    ...
    public SendRedPackResult sendRedPack(SendRedPack sendRedPack) throws MyException {
        ...
        HttpsClient httpsClient = new HttpsClient();
        //发起请求，发送普通红包
        Response response = httpsClient.postXmlWithCert("https://api.mch.weixin.qq.com/mmpaymkttransfers/sendredpack", xml, wx_mchId, wx_keyPath, wx_mchId);
        //获取微信平台下单接口返回数据
        String xmlResult = response.asString();
        try {
            //创建XML解析对象
    ...
    public SendRedpackInfo gethbinfo(String mch_billno, String appid) throws MyException {
        ...
        HttpsClient httpsClient = new HttpsClient();
        //发起请求，查询红包记录
        Response response = httpsClient.postXmlWithCert("https://api.mch.weixin.qq.com/mmpaymkttransfers/gethbinfo", xml, wx_mchId, wx_keyPath, wx_mchId);
        //获取微信平台下单接口返回数据
        String xmlResult = response.asString();
        try {
            //创建XML解析对象
