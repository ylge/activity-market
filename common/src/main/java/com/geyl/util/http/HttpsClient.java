...
public class HttpsClient implements java.io.Serializable {
     ...
     * @return 输出流对象
     */
    public Response postXmlWithOutCert(String url, String xml) throws MyException {
     ...
     * @return 输出流对象
     */
    public Response postXmlWithCert(String url, String xml, String mchId, String certPath, String certSecret) throws MyException {
     ...
     * @return 响应流
     */
    private Response sendHttpsRequest(String url, String method, String postData, boolean needCert, String partnerId, String certPath, String certSecret) throws MyException {
        ...
        try {
            ...
            if (status != OK) {
                switch (status) {
                    case 651:
                        throw new MyException("网络连接失败");
                    case 500:
                        throw new MyException("服务内部错误");
                    case 404:
                        throw new MyException("网址不存在");
                    default:
                        throw new MyException("系统繁忙，请稍候再试");
                }
            }
